    ...
    library changelog: false, identifier: "lib@ps-pt-job-fix-1", retriever: modernSCM([
        $class: 'GitSCMSource',
    ...
    options {
        ...
        stages {
            ...
            stage('Checkout') {
                steps {
                    deleteDir()
                    git poll: false, branch: "ps-pt-job-fix-1", url: "https://github.com/Percona-QA/package-testing.git"
                }
            }
